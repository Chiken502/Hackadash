...
class OnboardingScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Horizontal():
            ...
            with Vertical(classes="OBpanel"):
                ...
                yield Input(
                    placeholder="XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXXX", id="keyInput"
                )
                with Container(classes="bottom"):
        ...
        if button_id == "searchCfg":
            ...
            if config_file.is_file():
                ...
                try:
                    ...
                    self.api_key = (
                        config.get("settings", "api_key", fallback=None) or ""
                    )
                    self.api_url = (
                        config.get("settings", "api_url", fallback=None) or ""
                    )
    ...
    def create_config_file(self, api_key: str, api_url: str, mode: str = "manual"):
        ...
        config["General"] = {"version": "1.0.0", "environment": "development"}
